...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Form.bgimagee'
        db.add_column(u'forms_form', u'bgimagee',
                      self.gf('mezzanine.core.fields.FileField')(max_length=254, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Form.bgimagee'
        db.delete_column(u'forms_form', u'bgimagee')
    ...
    models = {
        ...
        u'forms.form': {
            ...
            u'bgimagee': ('mezzanine.core.fields.FileField', [], {'max_length': '254', 'null': 'True', 'blank': 'True'}),
